...
class DW4BSS(nn.Module):
    def __init__(self, nscheduler, config, **kwargs):
        super().__init__()
        self.nscheduler = nscheduler
        self.DW1 = DiffWave(nscheduler, config, **kwargs)
        self.DW2 = DiffWave(nscheduler, config, **kwargs)
        self.DW3 = DiffWave(nscheduler, config, **kwargs)
    ...
    def forward(self, x, t):
        ...
        out = out / torch.sqrt(self.nscheduler.BETA(t))
        return out
