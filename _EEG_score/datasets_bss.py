...
class train_dataset(Dataset):
    def __init__(self) -> None:
        super().__init__()
        self.perturbed_path = r'/home/wyl/projects/_EEG_score/data/perturbed_data/perturbed.npy'
        self.truth_path = r'/home/wyl/projects/_EEG_score/data/separated_data/combined.npy'
...
class test_dataset(Dataset):
    def __init__(self) -> None:
        super().__init__()
        self.perturbed_path = r'/home/wyl/projects/_EEG_score/data/perturbed_data/perturbed_test.npy'
        self.truth_path = r'/home/wyl/projects/_EEG_score/data/separated_data/combined_test.npy'
