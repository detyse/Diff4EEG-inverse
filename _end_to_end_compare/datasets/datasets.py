...
class train_dataset(Dataset):
    def __init__(self) -> None:
        super().__init__()
        self.perturbed_path = r'/home/wyl/projects/_BSS_latent/data/perturbed_data/perturbed.npy'
        self.truth_path = r'/home/wyl/projects/_BSS_latent/data/separated_data/combined.npy'
